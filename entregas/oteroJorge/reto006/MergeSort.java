...
public class MergeSort {
    ...
    public static void sort(int[] array, int left, int right) {
        if (left < right) {
            ...
            System.out.println("Dividiendo array desde el índice " + left + " hasta " + right);
            sort(array, left, middle);
            sort(array, middle + 1, right);

            // Une las mitades.
            System.out.println("Fusionando array desde el índice " + left + " hasta " + middle +
                    " y desde el índice " + (middle + 1) + " hasta " + right);
    ...
    private static void merge(int[] array, int left, int middle, int right) {
        ...
        // Mostrar el estado del array después de la fusión.
        System.out.println("Array fusionado desde el índice " + left + " hasta " + right +
