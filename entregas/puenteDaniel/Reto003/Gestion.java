...
public class Gestion {
    ...
    public void buscar() {
        ...
        for (Documento documento : documentos) {
            if (documento.getTitulo().equals(titulo)) {
                ...
                System.out.println("Año de publicacion: " + documento.getAño());
                ...
                for (String palabra : documento.getPalabras_clave()) {
    ...
    public void buscarPorPalabrasClave() {
        ...
        for (Documento documento : documentos) {
            for (String palabraClave : documento.getPalabras_clave()) {
                if (palabraClave.equals(palabra)) {
                    ...
                    System.out.println("Palabras clave: ");
                    for (String palabra2 : documento.getPalabras_clave()) {
