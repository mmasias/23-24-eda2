package entregas.puenteDaniel.Reto005;
...
public class ArrayAsociativo009 {
    ...
    public static void main(String[] args) {
        ...
        if (modoAutomatico){
            maze = iniciliazarMaze(castilloLB);
            System.out.println("Inicio modo Automatico");

        if(moverAutomatico(maze,personaje, ultimoMovimiento, castilloLB)){
            imprimirMundo(castilloLB, personaje);
        }else{
    ...
    static int [][] iniciliazarMaze(String mapa){
        int [][] maze = new int[mapa.length()][mapa.length()];
    ...
    static boolean moverAutomatico ( int[][] maze, int[] personaje, int direccion, String[] mapa){
        ...
        maze[x][y] = VISITED;
        imprimirMundo(mapa, personaje);
        System.out.println("Celda sin salida: Moviendo a (" + y + ", " + x + "): Marcando como visitado y retrocediendo.");
