...
public class ArrayAsociativo009 {
    ...
    public static void main(String[] args) {
        ...
        if (automatico){
            ...
            maza=inicializarMaid(castilloLB);
            if (movimientoAut(maza,elPersonaje,DERECHA,castilloLB)){
                imprimirMundo(castilloLB,elPersonaje);
            }else {
    ...
    static int[][] inicializarMaid(String []mapa){
        int[] [] maza=new int[mapa.length][mapa[0].length()];
...
return maza;
    ...
    static boolean movimientoAut(int[][ ] maze, int [] personaje, int direccion, String[] mapa){
