public class MergeSort {
    ...
    public static void sort(int[] array, int left, int right) {
        if (left < right) {
            ...
            System.out.println("Dividiendo: " + printSubArray(array, left, right));
    ...
    private static void merge(int[] array, int left, int middle, int right) {
        ...
        System.out.println("Fusionando: " + printSubArray(L, 0, n1 - 1) + " y " + printSubArray(R, 0, n2 - 1));
        ...
        System.out.println("Resultado de la fusión: " + printSubArray(array, left, right));
    }
