...
public class R5Laberinto {
    ...
    static boolean moverAutomatico(int[][]maze,int[] personaje,int direccion,String[]mapa){
        ...
        if (x < 0 || x >= maze.length || y < 0 || y >= maze[0].length) {
            System.out.println("Intentando moverse a: (" + x + ", " + y + ") - No se puede pasar, no está dentro de los límites.");
            return false;
        }
        if (maze[x][y] != FREE) {
            System.out.println("Intentando moverse a: (" + x + ", " + y + ") - No se puede pasar, no es un camino libre.");
            return false;
        }
