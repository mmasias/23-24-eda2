...
public class ArrayAsociativo009 {
    ...
    static void establecerObjetivo() {
        Scanner entrada = new Scanner(System.in);
        System.out.println("Ingrese la fila del objetivo:");
        int filaObj = entrada.nextInt();
        System.out.println("Ingrese la columna del objetivo:");
        int colObj = entrada.nextInt();
    
        if (filaObj < 0 || filaObj >= maxFila || colObj < 0 || colObj >= maxColumna) {
            System.out.println("Coordenadas fuera de los límites del mapa.");
        } else {
            objetivo[0] = filaObj;
            objetivo[1] = colObj;
            System.out.println("Objetivo establecido en (" + filaObj + ", " + colObj + ").");
        }
    }
