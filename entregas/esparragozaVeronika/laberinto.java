...
public class laberinto {
    static int[] elPersonaje = { 31, 33 };
    static int[] puntoFinal = { 10, 10 };
    ...
    public static void main(String[] args) {
        ...
        imprimirOpcionBusqueda();
    }
    private static void imprimirOpcionBusqueda() {
        System.out.println("Presiona 1 para recorrer manualmente el laberinto.");
        System.out.println("Presiona 2 para buscar el camino hacia el final del laberinto.");
        switch (inputUsuario()) {
            case 1:
                do {
                    actualizarTiempo();
                ...
                break;
            case 2:
                if (buscandoCamino(elPersonaje, castilloLB)) {
    ...
    static void imprimirLinea() {
        System.out.println(laberinto.mapear('B', modoVisualizacion).repeat( viewPort * 2 + 1));
    }
