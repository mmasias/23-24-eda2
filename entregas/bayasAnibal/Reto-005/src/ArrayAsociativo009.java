...
public class ArrayAsociativo009 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Bienvenido a la aventura de los castillos");
        System.out.println("=========================================");
        System.out.println("Instrucciones:");
        System.out.println("  - Usa las teclas W, A, S, D para moverte");
        System.out.println("  - Usa E para modo automático");
        do {
            actualizarTiempo();
        ...
        if (modoAutomatico) {
            ...
            if (moverAutomatico(maze, elPersonaje, ultimoMovimiento, castilloLB)) {
                imprimirMundo(castilloLB, elPersonaje);
            }
    ...
    public static boolean moverAutomatico(int[][] maze, int[] unPersonaje, int direccion, String[] mapa) {
        ...
        int x = unPersonaje[FILA];
        int y = unPersonaje[COLUMNA];
        ...
        if (moverAutomatico(maze, unPersonaje, DERECHA, mapa)) {
            return true;
        }
        if (moverAutomatico(maze, unPersonaje, ABAJO, mapa)) {
            return true;
        }
        if (moverAutomatico(maze, unPersonaje, IZQUIERDA, mapa)) {
            return true;
        }
        if (moverAutomatico(maze, unPersonaje, ARRIBA, mapa)) {
            return true;
        }
        maze[x][y] = VISITED;
        System.out.println("Retrocediendo ea (" + y + ", " + x + ")");
        imprimirMundo(mapa, unPersonaje);
