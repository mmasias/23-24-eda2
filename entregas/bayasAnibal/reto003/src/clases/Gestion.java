...
public class Gestion {
    ...
    private HashMap<String, ArrayList<Book>> indiceAutores;

    private HashMap<String, ArrayList<Book>> indicePalabrasClave;

    public Gestion(ArrayList<Book> documentos) {
        this.documentos = documentos;
        this.indiceAutores = new HashMap<String, ArrayList<Book>>();
        this.indicePalabrasClave = new HashMap<String, ArrayList<Book>>();
    }
    ...
    public void agregar() {
        ...
        for (Autor autor : autores) {
            if (indiceAutores.containsKey(autor.getNombre() + " " + autor.getApellido())) {
                ArrayList<Book> documentoAutor = indiceAutores.get(autor.getNombre() + " " + autor.getApellido());
