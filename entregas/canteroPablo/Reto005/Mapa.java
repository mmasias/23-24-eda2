...
public class Mapa {
    ...
    static double horasTranscurridas = 0;
    ...
    public static void main(String[] args) {
        ...
        if (modoAutomatico) {
            System.out.println("Moviendo automatico");
            maze =inicializarMaze(castilloLB);
            System.out.println("Inicializando modo automatico");
            if (moverAutomatico(maze, elPersonaje, DERECHA, castilloLB)) {
                imprimirMundo(castilloLB, elPersonaje);

            }else{
                System.out.println("No se encuentra la salida");
            }
        }
    }
    ...
    static int horasEnElMapa(int horaInicio) {
        horasTranscurridas = horasTranscurridas + 0.2;
    ...
    private static void imprimirStatus(int[] personaje) {
        ...
        imprimirLinea();
        System.out.print("HORA: [" + (int) hora + "] " + horasEnElMapa(9) + " horas lleva en el mapa");
    ...
    static boolean moverAutomatico(int[][]maze,int[] personaje,int direccion,String[]mapa){
        ...
        if (x==40 && y==42) {
            maze[x][y] = PATH;
            System.out.println("Lo lograste, has encontrado la salida en el modo automático");
            return true;
