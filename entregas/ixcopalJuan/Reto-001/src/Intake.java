...
class Intake {
    ...
    public void deleteIntake(){
        ...
        System.out.print("La comida: " + foodNameDelete + "se ha eliminado correctamente" + "\n");
        deleteFood(foodNameDelete);
    }
    public void editIntake(){
        System.out.println("Ingrese el nombre del alimento a editar: ");
        String foodNameEdit = new Scanner(System.in).nextLine();
        System.out.print("Editando la comida: " + foodNameEdit + "\n");
        deleteFood(foodNameEdit);

        System.out.println("Ingrese el nombre del alimento nuevo: ");
