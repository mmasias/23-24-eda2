...
class Day {
    ...
    public void createIntakes() {
        ...
        while (creating) {
            ...
            System.out.println("QUEEEE" + intakeName);
    ...
    public void editIntake(){
        Scanner userInput = new Scanner(System.in);
        System.out.println("Ingrese el nombre de la ingesta a editar: ");
        String intakeName = userInput.nextLine();
        IntakeNode current = first;
        while (current != null) {
        ...
        System.out.println("No se encontro la ingesta indicada :(");
    }

    public void deleteIntake(){
        Scanner userInput = new Scanner(System.in);
        System.out.println("Ingrese el nombre de la ingesta a eliminar: ");
        String intakeName = userInput.nextLine();
        IntakeNode current = first;
