public class MergeSortTrazabilidad {

    // Método para dividir y fusionar el array
    public static void sort(int[] array, int left, int right) throws InterruptedException {
        if (left < right) {
            ...
            // Imprime el estado del array después de fusionar.
            System.out.println("Estado del array después de fusionar las sub-arrays [" + left + "..." + middle + "] y [" + (middle + 1) + "..." + right + "]: " + arrayAsString(array));
            Thread.sleep(500);
        }
    }
