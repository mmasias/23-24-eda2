...
public class BubbleSort {
    public static void sort(int[] array) {
        ...
        do {
            ...
            passIndex++;
            System.out.println("Array después de la pasada " + passIndex + ":");
            for (int i : array) {
                System.out.print(i + " ");
            }
            System.out.println(); // Saltar línea para separar las pasadas
    ...
    public static void main(String[] args) {
        ...
        System.out.println(); // Saltar línea para separar el array original
        sort(data);
