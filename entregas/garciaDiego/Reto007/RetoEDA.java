        ...
        while (!sorted) {
            ...
            for (int j = 0; j < cartasOrdenadasNumero.length - 1 - passIndex; j++) {
                if (cartasOrdenadasNumero[j].getNumero() > cartasOrdenadasNumero[j + 1].getNumero()) {
                    System.out.println("Intercambio de los elementos: " + cartasOrdenadasNumero[j]
                            + " pasa a la derecha de " + cartasOrdenadasNumero[j + 1]);
        ...
        while (!sorted) {
            ...
            for (int j = 0; j < cartasOrdenadasPalo.length - 1 - passIndex; j++) {
                if (cartasOrdenadasPalo[j].getPalo() > cartasOrdenadasPalo[j + 1].getPalo()) {
                    System.out.println("Intercambio de los elementos: " + cartasOrdenadasPalo[j]
                            + " pasa a la derecha de " + cartasOrdenadasPalo[j + 1]);
