...
public class QuickSort {
 ...
 public static void sort(int[] array, int low, int high) {
    if (low < high) {
        System.out.println("Particionando el arreglo y obteniendo el índice del pivote en su posición correcta....");
        int pivotIndex = partition(array, low, high);
        System.out.println("Indice del pivote: " + pivotIndex);

        System.out.println("Ordenando los elementos antes y después de la partición...");
...
private static int partition(int[] array, int low, int high) {
    ...
    System.out.println("Se intercambia el pivote " + array[high] + " con el número en la posición i + 1 " + array[i + 1]);
    int temp = array[i + 1];
